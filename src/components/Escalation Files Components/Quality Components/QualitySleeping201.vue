  ...
  <a-config-provider :locale="enUS">
    ...
    <div class="sticky top-0 z-40 shadow">
      ...
      <div class="bg-white flex justify-center">
        <h2 class="text-2xl font-semibold py-1 mt-2">Sleeping 201/201 - Week</h2>
      ...
      <div class="inputs-container bg-white py-3 flex justify-around">
        ...
        <a-input
          placeholder="Ticket"
          :max="7"
          v-model="qualitySleepingStore.newRow.ticket"
          allow-clear
          :max-length="7"
          :style="{ width: '250px' }"
        />
        ...
        <!-- CINT ID Input -->
        <a-input
          v-model="qualitySleepingStore.newRow.cintID"
          placeholder="CINT ID"
          allow-clear
          :max-length="10"
          :style="{ width: '250px' }"
        ...
        <!-- Email Input -->
        <a-input
          v-model="qualitySleepingStore.newRow.email"
        ...
        <a-date-picker
          ...
          v-model="qualitySleepingStore.newRow.date"
          :style="{ width: '250px' }"
        />
    ...
    <div>
      ...
      >
        <thead>
          <tr>
            ...
            <th data-f-bold="true">Date last survey received</th>
        ...
        <tbody v-for="row in qualitySleepingStore.rows" :key="row.id">
          <tr class="border">
            ...
            <td data-label="DATE LAST SURVEY RECEIVED">
      ...
      <!-- Empty data display -->
      <div class="bg-white mx-auto mt-1 empty_data" v-show="qualitySleepingStore.rows.length === 0">
        <a-empty />
      </div>
      ...
      <div class="absolute bottom-10 z-50 mb-10 ml-10">
        <FloatingMenu
          ...
          @download-data="
            convertTable(
              sleepingTable,
              `Sleeping psReason 201 or 202_Not Receiving Surveys  Week ${storeWeek.week} - ${storeUser.fullName}`
            )
          "
        />
      </div>
...
import { useQualitySleeping } from "../../../stores/Escalation_Files_Stores/Quality_Stores/qualitySleeping201";
...
const qualitySleepingStore = useQualitySleeping();
...
function clearInputFields() {
  qualitySleepingStore.newRow.dateSubmitted = "";
  qualitySleepingStore.newRow.ticket = "";
  qualitySleepingStore.newRow.cintID = "";
  qualitySleepingStore.newRow.psReason = "";
  qualitySleepingStore.newRow.dateReactivated = "";
}

// Function to add new row to the table
function addNewRow() {
  qualitySleepingStore.$patch((state) => {
