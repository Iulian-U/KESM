  ...
  <a-config-provider :locale="enUS">
    ...
    <div class="sticky top-0 z-40 shadow">
      ...
      <div class="bg-white flex justify-center">
        <h2 class="text-2xl font-semibold py-1 mt-2">Beverages Diary - Week</h2>
      ...
      <div class="inputs-container bg-white py-3 flex justify-around">
        ...
        <a-input
          placeholder="Ticket"
          :max="7"
          v-model="beveragesStore.newRow.ticket"
          allow-clear
          :max-length="7"
          :style="{ width: '170px' }"
        />
        ...
        <!-- country Input-->
        <a-select
          v-model="beveragesStore.newRow.country"
        ...
        <!-- Project ID Input -->
        <a-input
          v-model="beveragesStore.newRow.projectID"
        ...
        <!-- CINT ID Input -->
        <a-input
          v-model="beveragesStore.newRow.cintID"
          placeholder="CINT ID"
          allow-clear
          :max-length="10"
          :style="{ width: '170px' }"
        ...
        <!-- Dummy ID Input -->
        <a-input
          v-model="beveragesStore.newRow.dummyID"
        ...
        <a-date-picker
          ...
          v-model="beveragesStore.newRow.date"
          :style="{ width: '170px' }"
        />

        <!-- Points issue Input -->
        <a-input
          v-model="beveragesStore.newRow.pointsIssue"
        ...
        <!-- tech issue Input -->
        <a-input
          v-model="beveragesStore.newRow.techIssue"
    ...
    <div>
      ...
      >
        ...
        <tbody v-for="row in beveragesStore.rows" :key="row.id">
          <tr class="border">
      ...
      <!-- Empty data display -->
      <div class="bg-white mx-auto mt-1 empty_data" v-show="beveragesStore.rows.length === 0">
        <a-empty />
      </div>
      ...
      <div class="absolute bottom-10 z-50 mb-10 ml-10">
        <FloatingMenu
          ...
          @download-data="
            convertTable(
              beveragesTable,
              `Beverage Weekly file Week ${storeWeek.week} - ${storeUser.fullName}`
            )
          "
        />
      </div>
...
import { useBeveragesStore } from "../../../stores/Escalation_Files_Stores/Special_Projects_Stores/beveragesStore";
...
function clearInputFields() {
  beveragesStore.newRow.ticket = "";
  beveragesStore.newRow.country = "";
  beveragesStore.newRow.projectID = "";
  beveragesStore.newRow.cintID = "";
  beveragesStore.newRow.dummyID = "";
  beveragesStore.newRow.date = "";
  beveragesStore.newRow.pointsIssue = "";
  beveragesStore.newRow.techIssue = "";
}

// Function to add new row to the table
function addNewRow() {
  beveragesStore.$patch((state) => {
