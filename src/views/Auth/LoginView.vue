<template>
  <div class="w-full h-screen flex justify-center items-center loginBackground">
    ...
    <div class="bg-white p-16 rounded-sm shadow-md">
      ...
      <!-- Form title -->
      <h2 class="text-indigo-500 text-xl font-semibold">Account Login</h2>

      <div class="demo-user-container py-2">
        <p class="py-1 italic text-indigo-500">Demo user: kesm@iulian-ursu.com</p>
        <p class="py-1 italic text-indigo-500">Password: P@ssword1234</p>
      </div>
      ...
      <a-space direction="vertical" size="large" :style="{ width: '350px' }">
        ...
        <a-form :model="form" :layout="layout">
          ...
          <!-- Form submit button -->
          <a-form-item>
            <a-button type="outline" @click="handleSubmit()">Login</a-button>
          </a-form-item>

          <!-- Link to register page -->
          <div class="my-2 flex text-gray-500 italic">
            <h2>Not a member?</h2>
...
// Function to login the user using useLogin composable
